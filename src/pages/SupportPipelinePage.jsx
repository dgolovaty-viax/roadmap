...
export default function SupportPipelinePage() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh' }}>
      <iframe
        src="/support-pipeline-2026.html"
        className="w-full h-screen border-0"
        title="viax AI-Augmented Support — 2026 Action Plan"
      />
        ...
        {open && (
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              <Btn onClick={() => downloadFile('/support-pipeline-2026.html', 'viax-support-pipeline-2026.html')}>
                <IconDownload /> HTML
              </Btn>
              <Btn onClick={() => window.open('/support-pipeline-2026.html', '_blank')}>
                <IconExternal /> View
              </Btn>
            </div>
          </div>
