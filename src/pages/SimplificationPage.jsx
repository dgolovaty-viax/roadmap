...
export default function SimplificationPage() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh' }}>
      <iframe
        src="/simplification-2026.html"
        className="w-full h-screen border-0"
        title="viax Simplification and Scaling — 2026 Action Plan"
      />
        ...
        {open && (
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              <Btn onClick={() => downloadFile('/simplification-2026.html', 'viax-simplification-2026.html')}>
                <IconDownload /> HTML
              </Btn>
              <Btn onClick={() => window.open('/simplification-2026.html', '_blank')}>
                <IconExternal /> View
              </Btn>
            </div>
          </div>
