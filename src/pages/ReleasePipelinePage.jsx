...
export default function ReleasePipelinePage() {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh' }}>
      <iframe
        src="/release-pipeline-2026.html"
        className="w-full h-screen border-0"
        title="viax AI-Augmented Releasing — 2026 Action Plan"
      />
        ...
        {open && (
          <div style={{
            ...
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              <Btn onClick={() => downloadFile('/release-pipeline-2026.html', 'viax-release-pipeline-2026.html')}>
                <IconDownload /> HTML
              </Btn>
              <Btn onClick={() => window.open('/release-pipeline-2026.html', '_blank')}>
                <IconExternal /> View
              </Btn>
            </div>
          </div>
